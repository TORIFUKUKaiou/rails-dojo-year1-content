...
### 📝 問題3：好きな食べ物を入れて表示する ( `stretch003.rb` )
...
### 📝 問題7：名前と年齢を1行で表示する ( `stretch007.rb` )
...
### 📝 問題8：趣味と出身を2行で表示する ( `stretch008.rb` )
...
### 📝 問題9：単価と個数から合計を出す ( `stretch009.rb` )
...
### 📝 問題10：10年後の年齢を表示する ( `stretch010.rb` )
...
### 📝 問題13：身長を m と cm に分ける ( `stretch013.rb` )
...
### 📝 問題18：ゲームのステータス画面 ( `stretch018.rb` )
...
### 📝 問題20：秒を時間・分・秒に分ける ( `stretch020.rb` )
...
### 📝 問題30：自己紹介カードを5行で作る ( `stretch030.rb` )
...
### 📝 問題32：表示してから上書きする ( `stretch032.rb` )
...
### 📝 問題33：計算結果を変数に入れる ( `stretch033.rb` )
...
### 📝 問題34：変数を使ったあとに上書きする ( `stretch034.rb` )
...
### 📝 問題37：文字列の中に空白を入れる ( `stretch037.rb` )
...
### 📝 問題38：変数名を読みやすくする ( `stretch038.rb` )
...
### 📝 問題39：使っていない変数を見つける ( `stretch039.rb` )
...
### 📝 問題41：プロフィールを文章にする ( `stretch041.rb` )
...
### 📝 問題51：`name` と `"name"` の違い ( `stretch051.rb` )
...
### 📝 問題53：文字列の中に変数を入れる ( `stretch053.rb` )
...
### 📝 問題58：変数名と表示したい文字 ( `stretch058.rb` )
...
### 📝 問題59：わざと `name` と表示する ( `stretch059.rb` )
...
### 📝 問題63：変数を作る前に使っている ( `stretch063.rb` )
...
### 📝 問題65：ハイフンではなくアンダースコア ( `stretch065.rb` )
...
### 📝 問題66：文字列と数値を `+` している ( `stretch066.rb` )
...
### 📝 問題67：計算するつもりが文字になっている ( `stretch067.rb` )
...
### 📝 問題68：計算結果を文章に入れる ( `stretch068.rb` )
...
### 📝 問題69：上書き前の値も残したい ( `stretch069.rb` )
...
### 📝 問題73：あとから変えても自動更新されない ( `stretch073.rb` )
...
### 📝 問題76：文字列の連結に空白を入れる ( `stretch076.rb` )
...
### 📝 問題99：自分で間違い探しを作る ( `stretch099.rb` )
...
### 📝 問題100：自分でミニアプリを作る ( `stretch100.rb` )
