...
### 📝 問題2：エレベーターの重量チェック ( `stretch002.rb` )
...
### 📝 問題11：入力したバッテリー残量で判定する ( `stretch011.rb` )
...
### 📝 問題12：入力した荷物の重さで判定する ( `stretch012.rb` )
...
### 📝 問題13：入力した注文状態でメッセージを出す ( `stretch013.rb` )
...
### 📝 問題14：入力した座席番号で左右を分ける ( `stretch014.rb` )
...
### 📝 問題15：入力した在庫数で表示を変える ( `stretch015.rb` )
...
### 📝 問題16：入力したカフェサイズで判定する ( `stretch016.rb` )
...
### 📝 問題17：入力したクーポンで判定する ( `stretch017.rb` )
...
### 📝 問題18：入力した入場情報で判定する ( `stretch018.rb` )
...
### 📝 問題19：入力した辛さで判定する ( `stretch019.rb` )
...
### 📝 問題20：入力した2つの数で大きい方を表示する ( `stretch020.rb` )
...
### 📝 問題21：入力した名前と年齢で自己紹介する ( `stretch021.rb` )

名前と年齢を入力して、自己紹介を表示し、そのあと年齢が18歳以上かどうかも表示してみましょう。

> [!TIP]
> 文字を入力するときは `gets.chomp` を使います。`chomp` をつけると、最後の改行が消えます。
...
### 📝 問題22：入力した値段と個数で送料判定する ( `stretch022.rb` )
...
### 📝 問題23：入力した3教科で平均点を出す ( `stretch023.rb` )
...
### 📝 問題24：入力した身長を変換して判定する ( `stretch024.rb` )
...
### 📝 問題25：入力した秒を分と秒に分ける ( `stretch025.rb` )
...
### 📝 問題26：入力した3つの値段でレシートを作る ( `stretch026.rb` )
...
### 📝 問題37：`elsif` は最初の1つだけ ( `stretch037.rb` )
...
### 📝 問題42：文字列の比較で `==` を使う ( `stretch042.rb` )
...
### 📝 問題43：変数ではなく文字を見ている ( `stretch043.rb` )
...
### 📝 問題45：表示だけが間違っている ( `stretch045.rb` )
...
### 📝 問題46：条件だけが間違っている ( `stretch046.rb` )
...
### 📝 問題47：数値を文字列として比べている ( `stretch047.rb` )
...
### 📝 問題51：100点を特別扱いする ( `stretch051.rb` )
...
### 📝 問題52：順番が悪いコードを直す その1 ( `stretch052.rb` )
...
### 📝 問題59：曜日でメッセージを変える ( `stretch059.rb` )
...
### 📝 問題61：入力した名前であいさつする ( `stretch061.rb` )
...
### 📝 問題62：入力した数が10以上か ( `stretch062.rb` )
...
### 📝 問題63：入力した点数を4段階に分ける ( `stretch063.rb` )
...
### 📝 問題65：入力した合計金額で送料判定 ( `stretch065.rb` )
...
### 📝 問題66：入力した体温で判定する ( `stretch066.rb` )
...
### 📝 問題67：入力した注文数で割引判定 ( `stretch067.rb` )
...
### 📝 問題68：入力した手でじゃんけん判定 ( `stretch068.rb` )
...
### 📝 問題69：入力した名前と点数でメッセージ ( `stretch069.rb` )
...
### 📝 問題70：入力した値段と個数で合計判定 ( `stretch070.rb` )
...
### 📝 問題73：条件のあとに `then` はいらない ( `stretch073.rb` )
...
### 📝 問題76：条件の文字列だけ間違い ( `stretch076.rb` )
...
### 📝 問題77：入力を数値にしていない ( `stretch077.rb` )
